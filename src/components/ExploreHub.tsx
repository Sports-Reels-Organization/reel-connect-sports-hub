                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    <Avatar className="w-10 h-10">
                      <AvatarImage src={request.agent.profile.avatar_url} />
                      <AvatarFallback>
                        {request.agent.profile.full_name?.charAt(0)}
                      </AvatarFallback>
                    </Avatar>
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        by {request.agent.profile.full_name}
                      </p>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">{request.budget_range}</p>
                  </div>
                  <div>
                    <span className="text-sm text-gray-400">Location:</span>
                    <p className="text-white font-medium">{request.location_preference}</p>
                  </div>
                </div>
